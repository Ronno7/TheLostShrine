...
Production kit: **12 designs total**. Keep the source sheets and native reference pixels used by the builder.
...
[Current village detail](../../Previews/tutorial-decoration-village.png) · [Current practice/rest detail](../../Previews/tutorial-decoration-practice.png) · [Painting guide](../../../../../TheLostShrine/Assets/Art/Tiles/Tutorial/DetailDecoration/README.md)
